      ...
      {Loading ?
        ...
        <>
          <div className='flex justify-end p-4 bg-slate-600'>
            <p onClick={() => { navigation("/Users") }} className='bg-green-500 w-fit px-2 py-1 rounded-lg cursor-pointer'>Users List</p>
          </div>
                ...
                <div className='mt-5'>
                  <thead className='bg-slate-800'>
                    <tr>
                      ...
                      <th className='border-sky-100 border px-2 py-2 min-w-[95px]'>Edit</th>
                    </tr>
                  </thead>
                  <tbody>
                ...
                <div className='flex flex-wrap justify-center w-[700px] max-md:w-full'>
                  {UserList.map((user, index) => (
                    <div className='flex flex-col w-[43%] bg-slate-800 rounded-lg justify-center items-center p-2 m-3'>
                      ...
                      <p className=''>email : </p>
                      <p className=' p-1 text-xs '>{user.email}</p>
                  <div className='text-center flex '>
                  <p onClick={() => { ToggleEditModal(index) }} className='bg-green-500 px-2 rounded m-2 cursor-pointer'>Edit</p>
                  <p onClick={() => { ToggleDeleteModal(index) }} className='bg-red-500 px-2 rounded m-2 cursor-pointer'>Delete</p>
                  </div>
                    </div>
                  ))}
                </div>
